...
template<typename Enum>
constexpr XE::EnableIfT<XE::FlagEnabledValue<Enum>, Enum> operator |(const Enum & Lhs, const Enum & Rhs)
{
...
template<typename Enum>
constexpr XE::EnableIfT<XE::FlagEnabledValue<Enum>, Enum> & operator |=(Enum & Lhs, const Enum & Rhs)
{
	using underlying = typename std::underlying_type<Enum>::type;
