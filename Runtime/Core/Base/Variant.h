...
namespace XE
{
	...
	public:
		...
		{
			if constexpr (IsSameV<T, void>) { ValueType = EValueType::None; }
			if constexpr (IsSameV<T, VoidT<T>>) { ValueType = EValueType::None; }
		...
		void Create()
		{
			if constexpr (IsSameV<T, char>) { ValueType = EValueType::Char; CharValue = {}; }
		...
		void Reset()
		{
			...
			else if (ValueType == EValueType::ReferPointer)
			{
				...
				Memzero(RawValue, RawVariableSizeMax);
			else {}
			ValueType = EValueType::None;
		}
		...
		FVariant & operator = (const FVariant & That)
		{
			...
			case EValueType::Float64:  Float64Value = That.Float64Value; break;
			case EValueType::Color:  ColorValue = That.ColorValue; break;
			case EValueType::String:  StringValue = That.StringValue; break;
			case EValueType::Pointer:
				PointerValue = That.PointerValue;
				PointerDeleter = nullptr;
				break;
		...
		FVariant & operator = (char Value) { Reset(); ValueType = EValueType::Char; CharValue = Value; return *this; }
		FVariant & operator = (wchar_t Value) { Reset(); ValueType = EValueType::WChar; WCharValue = Value; return *this; }
		FVariant & operator = (char8_t Value) { Reset(); ValueType = EValueType::Char8; Char8Value = Value; return *this; }
		FVariant & operator = (char16_t Value) { Reset(); ValueType = EValueType::Char16; Char16Value = Value; return *this; }
		FVariant & operator = (char32_t Value) { Reset(); ValueType = EValueType::Char32; Char32Value = Value; return *this; }
		
		FVariant & operator = (int8_t Value) { Reset(); ValueType = EValueType::Int8; Int8Value = Value; return *this; }
		FVariant & operator = (uint8_t Value) { Reset(); ValueType = EValueType::Int16; UInt8Value = Value; return *this; }
		
		FVariant & operator = (int16_t Value) { Reset(); ValueType = EValueType::Int8; Int16Value = Value; return *this; }
		FVariant & operator = (uint16_t Value) { Reset(); ValueType = EValueType::UInt16; UInt16Value = Value; return *this; }
		
		FVariant & operator = (int32_t Value) { Reset(); ValueType = EValueType::Int32; Int32Value = Value; return *this; }
		FVariant & operator = (uint32_t Value) { Reset(); ValueType = EValueType::UInt32; UInt32Value = Value; return *this; }
		
		FVariant & operator = (int64_t Value) { Reset(); ValueType = EValueType::Int64; Int64Value = Value; return *this; }
		FVariant & operator = (uint64_t Value) { Reset(); ValueType = EValueType::UInt64; UInt64Value = Value; return *this; }

		FVariant & operator = (float32_t Value) { Reset(); ValueType = EValueType::Float32; Float32Value = Value; return *this; }
		FVariant & operator = (float64_t Value) { Reset(); ValueType = EValueType::Float64; Float64Value = Value; return *this; }

		FVariant & operator = (const Vec2F & Value) { Reset(); ValueType = EValueType::Vec2F; Vec2FValue = Value; return *this; }
		FVariant & operator = (const Vec3F & Value) { Reset(); ValueType = EValueType::Vec3F; Vec3FValue = Value; return *this; }
		FVariant & operator = (const Vec4F & Value) { Reset(); ValueType = EValueType::Vec4F; Vec4FValue = Value; return *this; }
		FVariant & operator = (const Vec2I & Value) { Reset(); ValueType = EValueType::Vec2I; Vec2IValue = Value; return *this; }
		FVariant & operator = (const Vec3I & Value) { Reset(); ValueType = EValueType::Vec3I; Vec3IValue = Value; return *this; }
		FVariant & operator = (const Vec4I & Value) { Reset(); ValueType = EValueType::Vec4I; Vec4IValue = Value; return *this; }
		FVariant & operator = (const Vec2U & Value) { Reset(); ValueType = EValueType::Vec2U; Vec2UValue = Value; return *this; }
		FVariant & operator = (const Vec3U & Value) { Reset(); ValueType = EValueType::Vec3U; Vec3UValue = Value; return *this; }
		FVariant & operator = (const Vec4U & Value) { Reset(); ValueType = EValueType::Vec4U; Vec4UValue = Value; return *this; }

		FVariant & operator = (const FVector2 & Value) { Reset(); ValueType = EValueType::Vector2; Vector2Value = Value; return *this; }
		FVariant & operator = (const FVector3 & Value) { Reset(); ValueType = EValueType::Vector3; Vector3Value = Value; return *this; }
		FVariant & operator = (const FVector4 & Value) { Reset(); ValueType = EValueType::Vector4; Vector4Value = Value; return *this; }
		
		FVariant & operator = (FColor32 Value) { Reset(); ValueType = EValueType::Color; ColorValue = Value; return *this; }
		FVariant & operator = (FString Value) { Reset(); ValueType = EValueType::String; StringValue = Value; return *this; }

		template<typename T>
		FVariant & operator = (T * Value)
		{
			Reset();
		...
		template<typename T>
		FVariant & operator = (TReferPtr<T> Value)
		{
			Reset();
			ValueType = EValueType::ReferPointer;
			ReferPointerValue = ReferAddRef(Value.Get());
		...
		T Get() const
		{
			if constexpr (IsSameV<T, char>) { if (ValueType != EValueType::Char) throw EError::BadFormat; return CharValue; }
			...
			else if constexpr (IsSameV<T, FStringView>) { if (ValueType != EValueType::StringView) throw EError::BadFormat; return StringViewValue; }
			else if constexpr (IsReferPointerV<T>)
			{
