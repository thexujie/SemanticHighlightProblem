...
namespace XE
{
	...
	struct TMapItemTraitsT
	{
		...
		static const KeyT & GetKey(const TPair<KeyT2, ValueT2> & Pair) { return Pair.First; }

		template <typename KeyT2, typename ValueT2>
		static const ValueT & GetValue(const TPair<KeyT2, ValueT2> & Pair) { return Pair.Second; }

		template <typename KeyT2, typename ValueT2>
		static ValueT & GetValue(TPair<KeyT2, ValueT2> & Pair) { return Pair.Second; }
	};
	...
	public:
		...
		bool Containts(const KeyT & Key) const
		{
