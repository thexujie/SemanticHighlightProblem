...
#define DEFINE_SYSTEM_COLOR(SystemColor) {SystemColor, #SystemColor}
	...
	FStringView TConverter<FColor32>::ToString(const FColor32 & Color) const
	{
	...
	FColor32 TConverter<FColor32>::FromString(FStringView String) const
	{
		for (auto & SystemColor : Colors::SystemColors())
		{
