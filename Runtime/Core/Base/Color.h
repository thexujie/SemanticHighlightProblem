...
namespace XE
{
	...
	template<>
	class CORE_API TConverter<FColor32>
	{
	public:
		FStringView ToString(const FColor32 &) const;
		FColor32 FromString(FStringView String) const;
	};
    ...
    namespace Colors
    {
		...
		TVectorView<FSystemColor> SystemColors();
	}
	...
	public:
		...
		auto operator <=>(const FColor & Another) const = default; // { return TVec4<float32_t>::operator<=>(Another); }
